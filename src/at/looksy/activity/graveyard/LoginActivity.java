...
//		callingActivity = bundle.getString(Constants.BUNDLE_CALLING_ACTIVITY);
	}
...
//		bundle.putString(Constants.BUNDLE_CALLING_ACTIVITY, Util.activityClassName(this));
		
		Class<?> callingClass = null;
		try {
			callingClass = Class.forName(callingActivity);
